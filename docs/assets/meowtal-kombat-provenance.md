...
Status: idle, walk-forward, walk-back, crouch, jump, light-punch, hitstun, and blockstun rows approved for runtime publication; all other rows remain blocked pending separate scoped generation.
